...
survey_data_LARGE <- 
  ...
  mutate(vote_liberal = ifelse(p3==1,1,0),
         ...
         voting_duty = q76,
         volunteer_participation = q45,
         know_premier = q48,
         know_financemin = q49,
         more_refugees = case_when(
           q40 == 1 ~ "More Refugees",
           q40 == 2 ~ "Less Refugees",
           q40 == 3 ~ "same Amount",
           q40 == -9 || -8 || -7 ~ "Other"),
         more_immigrants = case_when(
           q39 == 1 ~ "More Immigrants",
           q39 == 2 ~ "Less Immigrants",
           q39 == 3 ~ "same Amount",
           q39 == -9 || -8 || -7 ~ "Other"),
         ...
         perceived_winner_riding = case_when(
           ...
           q37 == -9 || -8 || -7 ||7 ~ "Other"),
         opinion_fedeconomy = case_when(
           q32 == 1 ~ "Better",
           q32 == 2 ~ "Worse",
           q32 == 3 ~ "No difference",
           q32 == -9 || -8 || -7 ~ "Other"),
         opinion_economy = case_when(
           q31 == 1 ~ "Better",
           q31 == 2 ~ "Worse",
           q31 == 3 ~ "No difference",
           q31 == -9 || -8 || -7 ~ "Other"),
         opinion_immigrant_spending = case_when(
           q27_e == 1 ~ "Spend More",
           q27_e == 2 ~ "Spend Less",
           q27_e == 3 ~ "Same as now",
           q27_e == -9 || -8 || -7 ~ "Other"),
  ...
  select(vote_liberal, age, province, elec_interest, pref_party, lean_party, gov_satisfaction, know_premier, volunteer_participation, know_financemin, voting_duty, more_refugees, more_immigrants, perceived_winner, perceived_winner_riding, opinion_fedeconomy, opinion_economy, opinion_immigrant_spending,
opinion_defence_spending, opinion_crime_spending, opinion_environment_spending, opinion_trudeau, voted_2015, party_2015, watched_debate, education, religion, religion_importance, first_language, household_income, voted_2019, opinion_federal_performance, married, union, religious_attendence, control_of_power, vote_matters)
