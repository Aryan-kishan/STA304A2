...
survey_data_LARGE <- 
  ...
  select(vote_liberal, age, province, interest, pref_party, lean_party, gov_satisfaction, know_premier, volunteer_participation, know_financemin, voting_duty, more_refugees, more_immigrants, perceived_winner, perceived_winner_riding, opinion_fedeconomy, opinion_economy, opinion_immigrant_spending,
